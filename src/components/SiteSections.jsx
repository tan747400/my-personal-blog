    ...
    return (
      ...
      >
        <div className="flex w-full items-center justify-between px-6 py-4">
          <a
            href="/"
            className="text-3xl font-extrabold tracking-tight text-stone-800"
          >
    ...
    <div className="rounded-xl border border-stone-200 bg-white px-6 py-6">
      <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
        <div className="flex items-center gap-5">
          ...
          <a href="https://linkedin.com" className="inline-flex"><Linkedin className="h-5 w-5" /></a>
          <a href="https://github.com" className="inline-flex"><Github className="h-5 w-5" /></a>
          <a href="/" className="inline-flex"><Globe className="h-5 w-5" /></a>
          <a href="mailto:example@mail.com" className="inline-flex"><Mail className="h-5 w-5" /></a>
        </div>
        <a href="/" className="text-stone-900 underline underline-offset-4 hover:no-underline text-xl font-bold">
          Home page
        </a>
      </div>
    </div>
